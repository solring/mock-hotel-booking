  ...
  const memberOptions = () => {
    if(member) {
      return (
        <li className="nav-item ml-4">
          <Dropdown>
            <Dropdown.Toggle variant="light" href="#" className="d-flex centering-total-row px-3">
            ...
            <Dropdown.Menu aria-labelledby="DropdownMember">
              ...
              <Dropdown.Item><a href="#">My bookings</a></Dropdown.Item>
              <Dropdown.Item><a href="#">Privacy</a></Dropdown.Item>
              <Dropdown.Item><a href="#">Log out</a></Dropdown.Item>
            </Dropdown.Menu>
          </Dropdown>
        </li>
      );
    ...
    return (
      ...
      <div className="navbar-collapse collapse" id="navbarContent">
        <li className="nav-item">
          <Dropdown>
            <Dropdown.Toggle href="#" variant="light" className="centering-total-row ">
              <span className="material-icons icon-md">language</span>
            </Dropdown.Toggle>
            <Dropdown.Menu aria-labelledby="DropdownLang">
              {
                LANGUAGES.map((lan) => (<Dropdown.Item><a href="#">{lan}</a></Dropdown.Item>))
              }
            </Dropdown.Menu>
          </Dropdown>
        </li>
